...
class weapon_mp5 : ScriptBasePlayerWeaponEntity
{
	string gun_p = "models/hunger/p_hunger9mmar.mdl";
	string gun_v = "models/hunger/v_hunger9mmar.mdl";
	string gun_w = "models/hunger/w_hunger9mmar.mdl";
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( gun_v ), self.GetP_Model( gun_p ), MP5_DEPLOY, "mp5" );
	}
